    ...
    <form action="{{ route('assignments.store') }}" method="POST">
        ...
        <div class="row g-3 mb-4">
            ...
            <div class="col-md-4">
                ...
                <input type="text" name="role" class="form-control" value="{{ old('role') }}" placeholder="مثال: مشرف، عامل، مندوب">
            </div>
            <div class="col-md-4">
...
@if(old('location_id')) showLocInfo(document.getElementById('locSelect')); @endif
...
@if(old('employee_id')) updateAsgnEmpInfo(asgnSel); @endif
</script>
